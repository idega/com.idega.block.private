/**
 * @(#)SpecialHousingBenefitsServiceView.java    1.0.0 8:42:10 AM
 *
...
import is.idega.idegaweb.egov.reykjavik.process.presentation.SpecialHousingBenefitsServiceViewer;

/**
 * <p>Customized {@link com.idega.jbpm.view.View} for application for 
 * application for rental apartment/special housing subsidies</p>
 * <p>You can report about problems to: 
 * <a href="mailto:martynas@idega.is">Martynas Stakė</a></p>
 *
 * @version 1.0.0 Jul 15, 2013
 * @author <a href="mailto:martynas@idega.is">Martynas Stakė</a>
 */
public class SpecialHousingBenefitsServiceView extends
		DefaultSocialServiceProcessView {

	private static final long serialVersionUID = -8641103877324656233L;
	
	public static final String RESOURCE_IDENTIFIER = "special_housing_benefits_service_view";
	...
	public Class<? extends DefaultSocialServicesViewer> getViewerType() {
		return SpecialHousingBenefitsServiceViewer.class;
	}
	...
	public String getFaceletFilename() {
		return SpecialHousingBenefitsServiceViewer.FACELET_FILENAME;
	}
	...
	public String getProcessName() {
		return "SpecialHousingBenefitsServices";
	}
	...
	public String getLocalizationKey() {
		return "reykjavik.special_housing_benefits_services_view";
	}
	
	@Override
	public String getDefaultDisplayName() {
		return "Application for rental apartment/special housing subsidies";
	}
