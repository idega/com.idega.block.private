/**
 * @(#)HomeServicesView.java    1.0.0 8:21:41 AM
 *
...
import is.idega.idegaweb.egov.reykjavik.process.presentation.HomeServicesViewer;

/**
 * <p>Customized {@link com.idega.jbpm.view.View} for application of social 
 * services in the home</p>
 ...
 */
public class HomeServicesView extends DefaultSocialServiceProcessView {

	private static final long serialVersionUID = 1707187192130078976L;

	public static final String RESOURCE_IDENTIFIER = "home_service_view";
	...
	public Class<? extends DefaultSocialServicesViewer> getViewerType() {
		return HomeServicesViewer.class;
	}
	...
	public String getFaceletFilename() {
		return HomeServicesViewer.FACELET_FILENAME;
	}
	...
	public String getLocalizationKey() {
		return "reykjavik.home_services_view";
	}
	
	@Override
	public String getDefaultDisplayName() {
		return "Application of social services in the home";
	}
